...
#define  No_OF_TIME_CALL          (10U)

     /* first enable  CALIBARTION_EIN_DIS  then  SELECT_CALIBARTION_CHANNEL */  
		 /*****************To start calibartions  *************/
		 
#define        CALIBARTION_EIN_DIS           (1)  /* enable and disable the calibartions */
...
#define  S3_Button           ((GPIOA->IDR & GPIO_PIN_11)>>11)
#define  S4_Button           ((GPIOA->IDR & GPIO_PIN_5)>>5)
#define  IS_DG_Available     ((GPIOA->IDR & GPIO_PIN_6)>>5) /* 1=EB else DG  */
